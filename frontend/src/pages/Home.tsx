            ...
            <div className="map-placeholder">
              <div className="map-overlay">
                <div className="map-pins">
                  <div className="map-pin" style={{ top: '25%', left: '30%' }}>
                    <div className="pin-marker"></div>
                    <div className="pin-pulse"></div>
                    <div className="pin-tooltip">₺50/saat</div>
                  </div>
                  <div className="map-pin" style={{ top: '45%', left: '55%' }}>
                    <div className="pin-marker pin-marker-featured"></div>
                    <div className="pin-pulse"></div>
                    <div className="pin-tooltip">₺30/saat</div>
                  </div>
                  <div className="map-pin" style={{ top: '35%', left: '70%' }}>
                    <div className="pin-marker"></div>
                    <div className="pin-pulse"></div>
                    <div className="pin-tooltip">₺45/saat</div>
                  </div>
                  <div className="map-pin" style={{ top: '60%', left: '25%' }}>
                    <div className="pin-marker"></div>
                    <div className="pin-pulse"></div>
                    <div className="pin-tooltip">₺60/saat</div>
                  </div>
                  <div className="map-pin" style={{ top: '70%', left: '65%' }}>
                    <div className="pin-marker"></div>
                    <div className="pin-pulse"></div>
                    <div className="pin-tooltip">₺40/saat</div>
                  </div>
                </div>
